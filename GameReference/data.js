...
const ITEMS = {
  ...
  contracts: [
    { name: 'Basic Contract',  rarity: 'common',   notes: 'Standard recruitment for most human followers.' },
    { name: 'Silver Contract', rarity: 'uncommon', notes: 'Required for Monk and some Bandit paths. No combat needed.' },
    { name: 'Gold Contract',   rarity: 'rare',     notes: 'Required for Elven Grove Keeper and Rogue Elf.' },
    { name: 'Silver Bridle',   rarity: 'rare',     notes: 'Catch item for Kelpie — target must be below 50% HP.' },
    { name: 'Ancient Coin',    rarity: 'rare',     notes: 'Ritual item for Barrow Wight — placed at barrow entrance.' },
    { name: 'Glass Lantern',   rarity: 'uncommon', notes: 'Must be equipped to attract Will-o\'-Wisp in darkness.' },
  ],
  evolution_tokens: [
...
const STORY = {
  ...
  lordBackgrounds: [
    { lord: 'Lord Mesterby',     background: 'Friend reference. Appears as tutorial ally. Three betrayals. Becomes the boss.' },
    { lord: 'Lord Ezra',         background: 'Engineer. Designed his dungeon. Ice puzzle architect.' },
    { lord: 'Lord Mattheus',     background: 'Corruption first visible here. The shadow deepens.' },
    { lord: 'Lady Miriam',       background: 'First female lord boss. River and water as her domain.' },
    { lord: 'Border Lord (TBD)', background: 'Southern human border. Not yet finalised.' },
    { lord: 'Elder Erwin',       background: 'Elven elder. Grieving father. Wrong about who killed his son for years.' },
    { lord: 'Kalen',             background: 'Young Ashborn warrior becoming chief. Pledges to the player personally over Mason.' },
    { lord: 'The Dwarf King',    background: 'Falsely blamed by Erwin. Mountain ruler. 3-section dungeon.' },
  ],
};
